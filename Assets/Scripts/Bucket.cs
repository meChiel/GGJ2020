...
public class Bucket : MonoBehaviour
{
    ...
    void Update()
    {
        if (this.GetComponent<OVRGrabbable>().isGrabbed)
        {
            ...
            if (hand.name == "LeftHandAnchor") activeController = OVRInput.Axis1D.PrimaryIndexTrigger;
            else if (hand.name == "RightHandAnchor") activeController = OVRInput.Axis1D.SecondaryIndexTrigger; 
